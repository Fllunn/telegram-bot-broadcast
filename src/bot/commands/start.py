    ...
    async def handle_start(event: NewMessage.Event) -> None:
        ...
        await event.respond(
            (
                ...
                "Команды:\n"
                "• /login_phone — вход по номеру телефона (только для другого аккаунта, не того, через который вы сейчас в боте)\n"
                ...
                "• /auto_invasion — авто вступление в добавленные группы\n\n"
